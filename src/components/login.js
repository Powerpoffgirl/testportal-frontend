...
<div className="bg-customRed min-h-screen relative overflow-hidden">
      ...
      >
        ...
        >
          <div
            className="rounded-full p-2 pl-10 text-white font-bold text-sm md:text-base cursor-pointer"
            style={{
              width: "50%",
              height: "40px",
          ...
          <div
            className="rounded-full p-2 pl-10 text-customRed font-bold cursor-pointer text-sm md:text-base"
            style={{ width: "50%", height: "40px", backgroundColor: "white" }}
          >
            Doctor's Login
          </div>
        </div>
        <form className="flex flex-col ">
          ...
          <div
            className="flex justify-end m-3 md:w-413 sm:w-300"
