  ...
  const handleSubmit = async (e) => {
    ...
    if (isAdmin) {
      const response = await fetch(
        "https://dr.nixonbit.com/api/v1/admin/login",
        {
          method: "post",
          headers: {
  ...
  return (
    <>
      <div className="bg-customRed min-h-screen relative overflow-hidden">
        ...
        {/* Happy Durga puja. Jai Maa Durga */}
        <div
        ...
        >
          ...
          <div
            className="rounded-full flex flex-row p-2 m-3 md:w-413 sm:w-300"
            style={{ backgroundColor: "white" }}
          >
            <span
              className={`rounded-full p-2 pl-10  font-bold text-sm md:text-base cursor-pointer
              
               ${
                 isAdmin
                   ? "bg-customRed text-white"
                   : " text-customRed bg-white"
               }
            ...
            <span
              className={`rounded-full p-2 pl-10 font-bold cursor-pointer text-sm md:text-base 
              ${
                isDoctor ? "bg-customRed text-white" : "bg-white text-customRed"
              }
          ...
          <form className="flex flex-col ">
            <div className="flex flex-col items-center">
              <input
                ...
                placeholder={isDoctor?"Mobile No.":"Username/Email"}  
                value={email}
                onChange={(e) => {
