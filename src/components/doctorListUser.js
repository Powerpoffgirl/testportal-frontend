      ...
      >
        ...
        >
          <div className="flex flex-row gap-4 p-4 overflow-x-auto whitespace-nowrap hide-scrollbar">
            <button className="px-8 border-[#08DA75] border-2 bg-[#08DA75] text-lg">
              All
            </button>
            <button className="px-8 border-[#08DA75] border-2  text-lg">
              Cardiologist
            </button>
            <button className="px-8 border-[#08DA75] border-2  text-lg">
              Therapist
...
>>>>>>> 41d3b0ccb7e01af9ed9827b24049363ee02d6e62
}
