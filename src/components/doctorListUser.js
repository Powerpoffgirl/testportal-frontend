                                  ...
                                  {bookingslot?.map((data, index) =>
                                  {
                                      ...
                                      return (
                                        <Tooltip placement="top" title="Booked Slots">
                                          ...
                                          >
                                            <p>{monthName}</p>
                                            <p
                                              className=" p-2 pl-3 pr-3 border-2 rounded-lg "
                                              style={{
                                    ...
                                    } else if (index == currentIndex)
                                    {
                                      return (
                                        ...
                                        >
                                          <p>{monthName}</p>
                                          <p className=" p-2 border-2 pl-3 pr-3 rounded-lg bg-[#B3E7FB]">
                                            {day}
                                          </p>
                                          <p>{dayName}</p>
                                        </div>
                                    ...
                                    } else
                                    {
                                      return (
                                        ...
                                        >
                                          <p>{monthName}</p>
                                          <p className=" p-2 border-2 pl-3 pr-3 rounded-lg bg-gray-200">
                                            {day}
                                          </p>
                                          <p>{dayName}</p>
                                        </div>
