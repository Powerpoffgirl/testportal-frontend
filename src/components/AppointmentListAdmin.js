...
>>>>>>> 2b50c19ae8e8a882c86f1edd580b438c64ed910a
  ...
  const handleDeleteAppointment = async (appointmentId) =>
  {
    try
    {
      ...
      const response = await fetch(
        `${baseUrl}/api/v1/admin/delete_appointment/${appointmentId}`,
        {
    ...
    <>
      ...
      >
        <div className="flex flex-col bg-customRedp-2  items-center w-[100%] md:w-[100%]  mt-[2%]">
          ...
          >
            {selectedAppointment?.patientId?.age} yr,{" "}
          ...
          >
            Issues: {selectedAppointment?.issues.join(", ")}
            <br />
          ...
          >
            Appointment Date: {selectedAppointment?.appointmentDate?.date}
            <br />
          ...
          <div className="bg-white w-full p-4 sm:px-5 px-1 mb-5">
            <div className="flex flex-row justify-start items-center">
              ...
              >
                ...
                <div style={{ textAlign: "center" }}>
                  <h1
                    className="font-semibold text-gray-700 sm:text-lg text-sm capitalize"
                    style={{
                      marginLeft: isTab ? "2px" : "8px",
                      marginRight: isTab ? "4px" : "8px",
                    }}
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      paddingLeft: isTab ? 20 : null,
                      paddingRight: isTab ? 20 : null,
                    }}
                  >
