                        ...
                        >
                            ...
                            {/* <div className="flex flex-col md:flex-row justify-between">
                                <span className="flex flex-col w-[100%] md:w-[50%]">
                                    ...
                                    <span style={{ border: "1px solid #89CFF0", height: "40px", display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                            ...
                            <div className="mx-2 p-5" style={{ border: "1px solid #89CFF0", height: "20%" }}>
                                {/* Row1 */}
