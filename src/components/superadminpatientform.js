    ...
    const fetchPatientDetails = async () => {
      try {
        ...
        const response = await fetch(
          `${baseUrl}/api/v1/superAdmin/get_patient/${patientId}`,
          {
            method: "GET",
            headers: {
  ...
  return (
    <>
      ...
      <div class="grid grid-cols-1 w-full gap-4">
        <div className="flex  flex-col items-center justify-center w-full">
          <div className="cursor-pointer">
            ...
            >
              ...
              >
                {adminImage || patientDetails?.patientPic ? (
                  <img
                    src={adminImage || patientDetails?.patientPic}
                    alt="Avatar"
                    style={{
                      borderRadius: "50%",
                    }}
        ...
        <div>
          <label for="name" class="block text-black text-lg font-semibold">
            Name
          </label>
          <input
            type="text"
        ...
        <div>
          <label for="houseNo" class="block text-black text-lg font-semibold">
            Address
          </label>
