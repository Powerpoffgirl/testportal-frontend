...
export default function Header({ searchTerm, setSearchTerm, line1, line2, isAdd })
{
  ...
  return (
    ...
    <div>
      ...
      <div className={`bg-customRed w-full flex flex-row `}
        style={{
          left: "2%",
          height: "150px",
        ...
        <div className=" header-left"  >
          <div className="header-left-top" style={{
          ...
          <div className="header-left-bottom" style={{
            width: "80%", // Adjust the width percentage as needed
            height: "110px",
            marginTop: -66,
            marginLeft: "50%", // Center horizontally using left and transform properties
        ...
        <div className=" header-Right" style={{ display: "flex", flexDirection: "column" }}>
          <div>

            <div className="m-3 md:hidden  " onClick={handleToggleSidebar} style={{ marginLeft: '75%' }}>
              <span
                style={{
                  width: "8px",
                  height: "20px",
          ...
          <div style={{ display: "flex", flexDirection: 'row', marginTop: isTab ? "20px" : "80px", marginRight: isTab1 ? -45 : 60, marginLeft: isTab1 ? -40 : 0 }}>

            <div className="header-Right-top" >


              <span style={{ display: "flex", flexDirection: 'row', border: '2px solid white', borderRadius: 50, alignItems: 'center' }}> <span
                style={{
