...
export default function LabForgetpassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    const apiUrl = `${baseUrl}/api/v1/lab/reset_password/${id}`;
          ...
          <form className="flex flex-col ">
            <div onSubmit={handleSubmit} className="flex flex-col items-center">
              ...
              <input
                ...
                value={password}
                name="password"
                pattern=" (?=.*[a-zA-Z]): /^(?=.*\d)(?=.*[a-zA-Z]).{8,26}$/"
                onChange={handleChange}
                required
              ></input>
              <span style={{ color: "red", fontSize: "14px" }}>
                Password must have minimum 8 characters and include <br />
                atleast 1 uppercase,1 digit and 1 special characters
              </span>
              <input
                className="outline-none border-b-2 m-4 text-white  placeholder-white md:w-413 sm:w-300"
                style={{
