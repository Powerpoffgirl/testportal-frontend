...
export default function DoctorListAdmin()
{
    ...
    const handleToggleEditDoctorModal = (doctorId) =>
    {
        setEditDoctorId(doctorId); // This should set the state to the current doctor's ID
        setEditDoctorModalVisible(true); // And this should make the modal visible
    }
                        ...
                        <div style={{ marginTop: "10px" }}>
                            {
                                ...
                                (
                                    ...
                                    >
                                        {isEditDoctorModalVisible && (
                                            <EditDoctorModal
                                                show={isEditDoctorModalVisible}
                                                handleClose={() => setEditDoctorModalVisible(false)}
                                                doctorId={editDoctorId} // This should be the state that tracks the current doctor's ID
                                            />
                                        )}
                                        <div className="flex flex-row p-4 md:flex-row justify-between" onClick={() =>
                                            handleToggleEditDoctorModal(doctor._id)
                                        }>
