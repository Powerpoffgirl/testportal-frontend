...
export default function LabVerifyOtp() {
  ...
  const verifyOTP = async (e) => {
    ...
    //     `${baseUrl}/api/v1/doctor/verify_otp/${id}`,
    //     {
    //       method: "POST",
    //       headers: {
    //         "Content-Type": "application/json",
          ...
          <form className="flex flex-col ">
            <div className="flex flex-col items-center ">
              <div class="flex flex-row justify-center ">
                <input
                  className="outline-none border-b-2 m-4 text-white pl-2 placeholder-white  sm:w-300 w-2/5  "
                  style={{
                    height: "29px",
                ...
                <Tooltip placement="top" title="Resend OTP">
                  <LuRefreshCcw
                    className="Resend_icon mt-5 mr-4 hover:cursor-pointer w-1/5 "
                    style={{ color: "white" }}
                    onClick={SendOTP}
                  />
                </Tooltip>
