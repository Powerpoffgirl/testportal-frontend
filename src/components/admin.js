...
<span className="flex flex-col justify-start">
            ...
            >
              MBBS & MS (Padiatrics) degree from University of Bombay
            </text>
            <text
              className="ml-4 text-center mt-2"
              style={{
