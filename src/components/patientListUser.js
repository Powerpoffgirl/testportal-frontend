            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            {selectedPatient?.address?.houseNo + " " + selectedPatient?.address?.block + " " + selectedPatient?.address?.area + ", " + selectedPatient?.address?.district + ", " + selectedPatient?.address?.state + " " + selectedPatient?.address?.pinCode}
                        </text>
