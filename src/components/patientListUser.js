...
export default function PatientListUser({ searchTerm })
{
  ...
  {
    navigate("/medicialhistory", { state: { patientId: selectedPatient._id } }); // Navigate to the Medical History page
  };
    ...
    <>
      ...
      >
        ...
        <div className="flex justify-center mt-4">
          <button
            className="rounded-full px-4 sm:px-6 py-2 sm:py-2 text-white bg-[#89CFF0] text-xs sm:text-sm" // changed from 'rounded' to 'rounded-lg'
