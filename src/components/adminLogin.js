    ...
    return (
        <>
            <div className="bg-customRed min-h-screen relative overflow-hidden">
                ...
                >
                    {
                        !isTab ? (<div dangerouslySetInnerHTML={{ __html: svgContent3 }}></div>) : (
                            <div className="my-20" dangerouslySetInnerHTML={{ __html: smallSvgContent3 }}></div>
                        )
                    }
                    ...
                    <div
                        ...
                        style={{ backgroundColor: "white", display: "flex", justifyContent: "space-evenly", alignItems: "center", width: isTab ? "180px" : "300px" }}
                    >
                        <span
                            className={`rounded - full p - 2 pl - 10  cursor - pointer text-sm  bg-customRed text-white text-center`}
                            style={{ width: isTab ? "120%" : "90%", height: isTab ? "32px" : "40px", borderRadius: "25px", display: "flex", alignItems: "center", justifyContent: "space-evenly", fontSize: "18px" }}
                        >
                            Admin's Login
                        </span>
                    </div>
